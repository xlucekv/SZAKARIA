            ...
            subcommand
                ...
                .addChannelOption(option =>
                    option.setName('channel')
                        .setDescription('Kanał, na który będą wysyłane wiadomości pożegnalne')
                        .addChannelTypes(ChannelType.GuildText)
                        .setRequired(true))
                .addStringOption(option =>
                    option.setName('message')
                        .setDescription('Wiadomość pożegnalna. Zmienne: {user}, {username}, {server}, {memberCount}')
                        .setRequired(true))
                .addStringOption(option =>
                    option.setName('image')
                        .setDescription('URL obrazu do dołączenia do wiadomości pożegnalnej')
                        .setRequired(false))
                .addBooleanOption(option =>
                    option.setName('ping')
                        .setDescription('Czy oznaczyć użytkownika w wiadomości pożegnalnej')
                        .setRequired(false))),
    ...
    async execute(interaction) {
        ...
        if (subcommand === 'setup') {
            ...
            if (existingConfig?.goodbyeChannelId) {
                ...
                return await replyUserError(interaction, { type: ErrorTypes.UNKNOWN, message: `Pożegnania są już skonfigurowane na kanale <#${existingConfig.goodbyeChannelId}>. Użyj **/greet dashboard**, aby dostosować kanał, wiadomość, wzmiankę lub obraz.` });
            }
            ...
            try {
                await updateWelcomeConfig(client, guild.id, {
                    ...
                    leaveEmbed: {
                        ...
                        footer: `Pożegnanie z ${guild.name}!`,
                ...
                const embed = new EmbedBuilder()
                    ...
                    .setDescription(`Wiadomości pożegnalne będą teraz wysyłane na kanał ${channel}`)
                    .addFields(
                    ...
                    .setFooter({ text: 'Wskazówka: Użyj /greet dashboard, aby dostosować ustawienia pożegnań' });
